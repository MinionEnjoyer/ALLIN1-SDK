...
def test_current_guides_are_required_resources_and_versions_are_explicit():
    ...
    assert {"docs/sdk-guide.md", "docs/release-0.6.7.md", "docs/ui-readability.md", "docs/cli-reference.md", "docs/validation.md", "RELEASE_NOTES.md", "desktop/README.md"} <= required
