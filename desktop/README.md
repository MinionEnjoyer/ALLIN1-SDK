...
> 0.6.6 unsigned manual-download release. For scope and known validation limits,
> see the [release guide](../docs/release-0.6.6.md) and
...
0.6.6 uses unsigned manual downloads. The workflow uploads
