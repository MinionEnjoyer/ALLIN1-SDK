...
> 0.6.5 unsigned manual-download release. For scope and known validation limits,
> see the [release guide](../docs/release-0.6.5.md) and
...
0.6.5 uses unsigned manual downloads. The workflow uploads
