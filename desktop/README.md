...
> 0.6.7 unsigned manual-download release. For scope and known validation limits,
> see the [release guide](../docs/release-0.6.7.md) and
...
0.6.7 uses unsigned manual downloads. The workflow uploads
