...
OFFICIAL_VEHICLE_MODEL_HASH_PAIRS: tuple[tuple[str, int], ...] = (
    ...
    ("caracara3", 0x9DD0CBB1),
    ("carbonizzare", 0x7B8AB45F),
    ("carbonrs", 0x00ABB0C0),
    ("cargobob", 0xFCFCB68B),
    ("cargobob2", 0x60A7EA10),
    ("cargobob3", 0x53174EEF),
    ("cargobob5", 0xEAFA7EB7),
    ("cartuccia", 0x876BE547),
    ("casco", 0x3822BDFE),
    ("castigator", 0x4DF2780F),
    ...
    ("coquette5", 0x8B44BEFB),
    ("coquette6", 0x0796B7A5),
    ("corsita", 0xD3046147),
    ("coureur", 0x24626C26),
    ("cruiser", 0x1ABA13B5),
    ("crusader", 0x132D5A1A),
    ...
    ("phoenix", 0x831A21D5),
    ("picador", 0x59E0FBF3),
    ("pipistrello", 0xF2AE3F81),
    ("pizzaboy", 0x75599EA7),
    ("polbuffalo", 0x11291A17),
    ("polbuffalo6", 0x24CE9073),
    ("polcaracara", 0x8BD565B8),
    ("polcoquette4", 0x79C12D73),
    ("poldominator10", 0xD1E0B7D7),
    ("poldorado", 0x9EF6AEC7),
    ("polfaction2", 0x70B8833A),
    ("polgauntlet", 0xB67633E6),
    ("polgreenwood", 0x678DD3EA),
    ("police", 0x79FBB0C5),
    ("police2", 0x9F05F101),
    ("police3", 0x71FA16EA),
    ("police4", 0x8A63C7B9),
    ...
    ("policet3", 0xA9E13F3D),
    ("polignus", 0xFDAB9FC7),
    ("polimpaler5", 0x4A78B890),
    ("polimpaler6", 0x568BD0B6),
    ("polmav", 0x1517D4D9),
    ("polterminus", 0xB1412350),
    ("pony", 0xF8DE29A8),
    ("pony2", 0x38408341),
    ("postlude", 0xEE6F8F79),
    ("pounder", 0x7DE35E7D),
    ...
    ("sentinel5", 0xA17C88F3),
    ("sentinel6", 0xEA9F9B38),
    ("serrano", 0x4FB1A214),
    ("seven70", 0x97398A4B),
    ("sheava", 0x30D3F6D8),
    ("sheriff", 0x9BAA707C),
    ...
    ("stingertt", 0x5649FF41),
    ("stockade", 0x6827CF72),
    ("stockade3", 0xF337AB36),
    ("stockade4", 0x40F546B0),
    ("stratum", 0x66B4FC45),
    ("streamer216", 0x0B706A72),
    ("streiter", 0x67D2B389),
    ("stretch", 0x8B13F083),
    ...
    ("visione", 0xC4810400),
    ("vivanite", 0xAE2CC02A),
    ("vivanite2", 0x1E41B223),
    ("volatol", 0x1AAD0DED),
    ("volatus", 0x920016F1),
    ("voltic", 0x9F4B77BE),
    ("voltic2", 0x3AF76F4A),
    ("voodoo2", 0x1F3766E3),
    ("vorschlaghammer", 0xB614798D),
    ("vortex", 0xDBA9DBFC),
    ("vstr", 0x56CDEE7D),
    ("warden", 0x8CD6404E),
    ...
    ("woodlander", 0x75397001),
    ("xa21", 0x36B4A8A9),
    ("xls2", 0xE6401328),
    ("xtreme", 0x95F6A2C9),
    ("yosemite", 0x6F946279),
    ("yosemite1500", 0x8EF5E388),
